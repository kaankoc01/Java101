public class BurcBulma {
 public static void main(String[] args) {
    ...
    // equalsIgnoreCase = java büyük küçük harfe duyarlı bir dildir. bu metod büyük küçük harf duyarlılığını yok eder.
    System.out.println("Lütfen doğduğunuz ayi yaziniz");
    String ay=klavye.next();
 
    System.out.println("Lütfen doğduğunuz günü yaziniz");
